...
public class AirportSelection extends AppCompatActivity {


    private static String TAG = "airport";
    RecyclerView recyclerView;

    List<Datum> listeAut;
    InfoSerach mAdapter = new InfoSerach(listeAut,AirportSelection.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.display_infos);
        ...
        Request request = new Request.Builder()
                .url("https://api.checkwx.com/metar/" + name + "/decoded?x-api-key=bbc56e91998c41fe8b8b6a9384")
                .build();
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                AirportSelection.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(getApplicationContext(), "runn", Toast.LENGTH_SHORT).show();
                        mAdapter.setData(dataSearch.getData());
                        recyclerView.setAdapter(mAdapter);
                        recyclerView.setLayoutManager(new LinearLayoutManager(AirportSelection.this));
